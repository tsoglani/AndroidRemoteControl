                                                ...
                                                new Thread() {
                                                    ...
                                                    public void run() {
                                                        try {
                                                            ...
                                                            MouseUIActivity.ps.println("GLOBAL_IP");
                                                            runOnUiThread(new Thread() {
                                                                @Override
                                                                public void run() {
                                                                    Log.i(Boolean.toString(InternetConnection.returnSocket.isConnected()), "InternetConnection.returnSocket.isConnected()");
...
//                    s = new Socket(ip, 6667);
    ...
    public void infoFunction(View v) {
        ...
        Spanned myLnk=Html.fromHtml("<a href=https://raw.githubusercontent.com/tsoglani/AndroidRemoteJavaServer/master/Internet%20Image%20Example/Screenshot%202.png> Port Forwarding Example</a>");
